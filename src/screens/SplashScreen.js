...
function SplashScreen(props) {
    ...
    return (
        <OtrixContainer customStyles={{ backgroundColor: Colors.white }}>
            <View style={{ backgroundColor: Colors.white, flex: 0.90 }}>
            ...
            <Text style={{ flex: 0.10, marginHorizontal: wp('10%'), color: Colors.black }} numberOfLines={2}>Nation's First Digital Platform For GI Tag and Native Crops</Text>
        </OtrixContainer >
    )

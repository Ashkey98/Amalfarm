...
function SoilTesting(props){
    ...
    return(
        ...
        <OtrixHeader >
                ...
                <View style={[GlobalStyles.headerCenter, { flex: 1 }]}>
                    <Text style={GlobalStyles.headingTxt}> Soil Testing</Text>
                </View>
            </OtrixHeader>
 ...
 <Text style={{fontSize:18,color:"white"}}>Need Soil Testing : </Text>
      ...
      <Text style={{fontSize:18,color:"white"}}> No </Text>
                        ...
                        <OtrixDivider size={'md'} />
     <View style={{display:"flex", flexDirection:"row"}}>
 <Text style={{fontSize:18,color:"white"}}>Sample Ready : </Text>
      ...
      <Text style={{fontSize:18,color:"white"}}> No </Text>
                ...
                <OtrixDivider size={'md'} />  
                <View style={{display:"flex", flexDirection:"row"}}>
 <Text style={{fontSize:18,color:"white"}}>Sample Submit : </Text>
      ...
      <Text style={{fontSize:18,color:"white"}}> No </Text>
            ...
            <Text style={{fontSize:18,color:"white"}}>Sample Picture : </Text>
                <Button
                            size="md"
                            variant="solid"

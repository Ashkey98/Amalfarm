...
export const news = require('../assets/images/news.png')
export const news_fill = require('../assets/images/news_fill.png')
...
export const laneng = require('../assets/images/whitehouse.png')
export const lanhindi = require('../assets/images/gateogindia.png')
export const lanmarathi = require('../assets/images/indiagate.png')
export const lanbangali = require('../assets/images/tajmahal.png')
export const farm = require('../assets/images/farm.jpg')
export const language = require('../assets/images/language.jpg')
export const giscreen = require('../assets/images/giscreen.jpg')
export const loginpage = require('../assets/images/loginpage.jpg')
export const forgot = require('../assets/images/forgot.jpg')

export const slider1 = require('../assets/images/slider1.jpg')
export const slider2 = require('../assets/images/slider2.jpg')
